package com.jd.blockchain.tools.activeparti.boot;

import com.jd.blockchain.tools.activeparti.ActivePartiCommand;
...
public class ActivePartiBooter {
	...
	private static List<File> loadPaths() {
		...
		URL url = ActivePartiBooter.class
				.getProtectionDomain()
				.getCodeSource()
				.getLocation();
		try {
