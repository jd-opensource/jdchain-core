package com.jd.blockchain.tools.deactiveparti.boot;

import com.jd.blockchain.tools.deactiveparti.DeactivePartiCommand;
...
public class DeactivePartiBooter {
	...
	public static void main(String[] args) {
		load();
		DeactivePartiCommand.main(args);
	}
	...
	private static List<File> loadPaths() {
		...
		URL url = DeactivePartiBooter.class
				.getProtectionDomain()
				.getCodeSource()
				.getLocation();
		try {
