...
public class DatasetHelperSimple {
	 ...
	 * @return
	 */
	public static <V> SimpleDataset<String, V> map(SimpleDataset<Bytes, V> dataset) {
	 ...
	 * @return
	 */
	public static <V1, V2> SimpleDataset<String, V2> map(SimpleDataset<Bytes, V1> dataset, TypeMapper<V1, V2> valueMapper) {
	 ...
	 * @return
	 */
	public static <K1, K2, V1, V2> SimpleDataset<K2, V2> map(SimpleDataset<K1, V1> dataset, TypeMapper<K1, K2> keyMapper,
	 ...
	 * @return 植入监听器的数据集实例；
	 */
	public static <K, V> SimpleDataset<K, V> listen(SimpleDataset<K, V> dataset, DataChangedListener<K, V> listener) {
	...
	private static class DatasetUpdatingMonitor<K, V> implements SimpleDataset<K, V> {

		private SimpleDataset<K, V> dataset;

		private DataChangedListener<K, V> listener;

		public DatasetUpdatingMonitor(SimpleDataset<K, V> dataset, DataChangedListener<K, V> listener) {
	 ...
	 * @param <V2>
	 */
	private static class TypeAdapter<K1, K2, V1, V2> implements SimpleDataset<K2, V2> {
		private SimpleDataset<K1, V1> dataset;
		private TypeMapper<K1, K2> keyMapper;
		private TypeMapper<V1, V2> valueMapper;

		public TypeAdapter(SimpleDataset<K1, V1> dataset, TypeMapper<K1, K2> keyMapper, TypeMapper<V1, V2> valueMapper) {
			this.dataset = dataset;
