...
public interface OperationHandle {
     ...
     *
     * @param op              操作实例；
     * @param transactionContext 交易上下文信息，包含需要修改的新区块的数据集；
     * @param requestContext  交易请求上下文；
     * @param handleContext   操作上下文；
     * @return
     */
    BytesValue process(Operation op, LedgerTransactionContext transactionContext, TransactionRequestExtension requestContext,
