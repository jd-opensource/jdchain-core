...
public class LedgerAdminDataSetEditorSimple implements Transactional, LedgerAdminDataSet, LedgerAdminSettings {
	...
	private static Logger LOGGER = LoggerFactory.getLogger(LedgerAdminDataSetEditorSimple.class);
	 ...
	 */
	public LedgerAdminDataSetEditorSimple(LedgerInitSetting initSetting, String keyPrefix, ExPolicyKVStorage exPolicyStorage,
